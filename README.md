...
Typical workflow timing (using Groq free tier with parallel execution):
...
| Interview Prep | 4-6s |
| Cover Letter | 3-5s |
| **Total (parallel)** | **10-15s** |

## 🎓 Learning Value

This project demonstrates production AI patterns:
- ✅ **Multi-agent systems** - LangGraph orchestration
- ✅ **LLM integration** - Groq API + structured outputs
- ✅ **Type safety** - Pydantic models
- ✅ **Error handling** - Graceful degradation
- ✅ **Async patterns** - Scalable execution
- ✅ **Web UI** - Streamlit deployment
- ✅ **File processing** - PDF/DOCX extraction

Perfect for AI engineering portfolios! 🚀
...
- More output formats (PDF)

## 📄 License

MIT License - Use for portfolio projects

## ❓ FAQ

**Q: Do I need a paid Groq plan?**  
A: No! Free tier works perfectly (30 req/min limit).

**Q: Can I use a different LLM?**  
A: Yes! Edit `src/config.py` to use OpenAI, Claude, etc.

**Q: What file formats are supported?**  
A: PDF, DOCX, and TXT (max 10MB each).

**Q: How accurate are the results?**  
A: Results are AI-generated suggestions. Always review before submitting applications.

**Q: Can I use this for multiple job applications?**  
A: Yes! Run the analysis for each job separately to get tailored results.

## 📞 Support

If issues occur:
1. Check `.env` has valid GROQ_API_KEY
2. Run test: `python main.py --demo`
3. Check `results.json` for error details
4. Review `src/config.py` timeout settings

---

Built with LangGraph, Groq, and Streamlit | Perfect for AI engineering roles
